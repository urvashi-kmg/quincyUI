# Prompt Template — AI Self-Review / PR Hardening

## 1. CONTEXT & OBJECTIVE
Review the existing implementation or diff without making changes initially.
...
First identify findings grouped by severity: blocker, high, medium, low — see
`.claude/rules/clarification-protocol.md` for the severity definitions. Only after findings are
reported and any blockers are discussed should you propose or make changes.
