# Prompt Template — Testing / Coverage Improvement

## 1. CONTEXT & USER STORY
Describe the area where test coverage or confidence is insufficient.
...
- {{CRITERION_1}}
- {{CRITERION_2}}
- Coverage moves closer to the thresholds in `vitest.config.ts` without gaming trivial cases.
