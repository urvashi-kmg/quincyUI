# Prompt Template — Safe Refactor (No Behavior Change)

## 1. CONTEXT & USER STORY
Describe the code-quality problem and explicitly state what must remain unchanged.

**Refactor goal:**
> {{REFACTOR_GOAL}}

**Must remain unchanged:**
- public behavior, component props, Redux slice shape, service contracts
- visual behavior (verify against existing Storybook stories)
...
- {{CRITERION_1}}
- {{CRITERION_2}}
- Existing tests pass unmodified, or changes to them are explained and approved.
