# Prompt Template — Bug Fix + Regression

## 1. CONTEXT & USER STORY
Describe the observed bug and expected behavior.
...
- {{CRITERION_1}}
- {{CRITERION_2}}
- A regression test is added at the lowest layer that would have caught this bug.
