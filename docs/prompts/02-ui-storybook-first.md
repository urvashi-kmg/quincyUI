# Prompt Template — UI / Storybook-First Change

## 1. CONTEXT & USER STORY
Describe the UI change, user journey, target component/page, responsive requirements, and
acceptance criteria.

**UI request:**
> {{DESCRIBE_UI_CHANGE}}

**Existing story/component reference (if any):**
